    ...
    const updatedUser = await User.findByIdAndUpdate(
      req.user.id,
      {
        $set: {
          ...
          "applicantDetails.motherFirstName": req.body.motherFirstName,
          "applicantDetails.motherMiddleName": req.body.motherMiddleName,
          "applicantDetails.motherLastName": req.body.motherLastName,
          "applicantDetails.motherDOB": req.body.motherDOB,
          "applicantDetails.fatherFirstName": req.body.fatherFirstName,
          "applicantDetails.fatherMiddleName": req.body.fatherMiddleName,
          "applicantDetails.fatherLastName": req.body.fatherLastName,
          "applicantDetails.fatherDOB": req.body.fatherDOB,
        },
      },
