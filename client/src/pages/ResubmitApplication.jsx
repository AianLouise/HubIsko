...
export default function ResubmitApplication() {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            try {
                ...
                // Set formData without the documents field
    ...
    useEffect(() => {
        const fetchScholarshipDetails = async () => {
            if (userDetails && userDetails.scholarshipProgram) {
                try {
                    const response = await fetch(`/api/scholarshipProgram/scholarship-programs/${userDetails.scholarshipProgram._id}`);
        ...
        const fetchRequiredDocuments = async () => {
            if (userDetails && userDetails.scholarshipProgram) {
                try {
                    const response = await fetch(`/api/scholarshipProgram/${userDetails.scholarshipProgram._id}/required-documents`);
                    ...
                    {scholarship && (
                        <div className="scholarship-info mb-4 p-6 bg-white rounded-lg shadow-md">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h2 className="lg:text-2xl font-normal text-slate-500 lg:text-gray-800">You are resubmitting your application for
