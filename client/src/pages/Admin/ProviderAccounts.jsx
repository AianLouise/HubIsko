    ...
    <main className="flex-grow bg-[#f8f8fb] font-medium text-slate-700">
      <div className='max-w-8xl mx-auto px-24 gap-4 flex-col flex mt-12'>
        ...
        <div className='flex gap-4'>
          <div className='overflow-x-auto rounded-md bg-white shadow border w-[100rem]'>
              ...
              <tbody>
                {providers.map((provider, index) => (
                  <tr key={provider._id} className="font-normal tracking-wide hover:bg-slate-200">
                    ...
                    <td className='py-2 px-4 border-b border-gray-200'>{provider.scholarshipProviderDetails.organizationName}</td>
            ...
            <div className='flex justify-between items-center font-normal gap-4 p-4 py-6 text-gray-600 rounded-md'>
              <span>Showing items 1 out of 8</span>
