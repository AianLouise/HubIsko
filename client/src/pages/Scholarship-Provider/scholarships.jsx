            ...
            <>
              <div className="flex justify-between p-6 border-b items-center gap-2 bg-white shadow rounded-md mb-4">
                <div className='flex gap-2 font-medium text-sm'>
                  ...
                  >
                    All <span className={`text-blue-600 ${filter === 'All' ? 'text-white' : ''} group-hover:text-blue-600`}>({scholarships.length})</span>
                  </button>
                  ...
                  >
                    Published <span className={`text-indigo-600 ${filter === 'Published' ? 'text-white' : ''} group-hover:text-indigo-600`}>({scholarships.filter(scholarship => scholarship.status === 'Published').length})</span>
                  </button>
                  ...
                  >
                    Completed <span className={`text-green-600 ${filter === 'Completed' ? 'text-white' : ''} group-hover:text-green-600`}>({scholarships.filter(scholarship => scholarship.status === 'Completed').length})</span>
                  </button>
                </div>
