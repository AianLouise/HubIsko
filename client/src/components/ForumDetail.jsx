            ...
            <main className='flex-grow bg-[#f8f8fb] no-scrollbar font-medium text-slate-700'>
                ...
                <div className='flex flex-col gap-8 mx-auto max-w-6xl p-2 lg:px-24'>
                    ...
                    <div className='flex gap-1 mt-10 items-center'>
                        <Link to={currentUser.role === 'scholarship_provider' ? '/provider-forums' : '/Forums'}>
                            <button className='bg-white border shadow px-4 py-1 mr-2 rounded-md hover:bg-slate-200 transition ease-in-out'>
                                Forums
                            </button>
                        </Link>
