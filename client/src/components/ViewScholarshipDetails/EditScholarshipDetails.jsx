    ...
    return (
        <div className="flex flex-col">
            ...
            <form onSubmit={handleSaveChanges}>
                ...
                <div className='bg-white p-8 py-12 flex flex-col rounded-md border shadow'>
                    <h2 className="text-2xl font-bold mb-4 border-b-2 pb-4">Scholarship Duration <span className='text-red-500'>*</span></h2>
                    <div className='flex flex-col gap-4 px-4 space-y-1 mt-4'>
                        <div>
                ...
                <div className='bg-white p-8 py-12 flex flex-col rounded-md border shadow'>
                    <h2 className="text-2xl font-bold mb-4 border-b-2 pb-4">Contact Information <span className='text-red-500'>*</span></h2>
                    <div className='flex flex-col gap-4 px-4 space-y-1 mt-4'>
                        <div>
