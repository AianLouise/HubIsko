  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <p className="mb-4">Your email <strong>{emailAddress}</strong> is not verified. Please check your inbox for the verification email or click the button below to resend the verification email.</p>
        <button
